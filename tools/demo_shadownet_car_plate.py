...
def recognize(image_path_dir, weights_path, is_vis=False):
    ...
    :return:
    """
    inputdata = tf.placeholder(dtype=tf.float32, shape=[1, 32, config.cfg.TRAIN.IMAGE_WIDTH, 3], name='input')
    ...
    sess_config = tf.ConfigProto(device_count={'GPU': 1, 'CPU': 4},log_device_placement=False)
