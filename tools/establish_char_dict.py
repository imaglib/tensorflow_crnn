...
def init_args():
    ...
    parser.add_argument('--char_dict_file', type=str, help='The char dict file')
    parser.add_argument('--save_dir', type=str, help='The save dir path', default='data/char_dict')
...
if __name__ == '__main__':
    ...
    args.char_dict_file = 'data/char_dict/chinese_dict.txt'
    args.save_dir = 'data/char_dict/'
